...
//    private static final String DOC_2_DOCX = "World_Wide_Corp_Battle_Plan_Trafalgar.docx";
	...
	private static final String ENVELOPE_1_DOCUMENT_1 = "<!DOCTYPE html>" + "<html>" + "    <head>"
			...
			+ "         color: darkblue;\">Order Processing Division</h2>" + "  <h4>Ordered by " + DSConfig.SIGNER_NAME1
			+ "</h4>" + "    <p style=\"margin-top:0em; margin-bottom:0em;\">Email: " + DSConfig.SIGNER_EMAIL1 + "</p>"
			+ "    <p style=\"margin-top:0em; margin-bottom:0em;\">Copy to: " + DSConfig.CC_NAME + ", "
			+ DSConfig.SIGNER_EMAIL1 + "</p>" + "    <p style=\"margin-top:3em;\">"
			...
			+ " cake gummies lollipop sugar plum ice cream gummies cheesecake." + "    </p>"
	 ...
	 * @throws IOException
	 */
	public EnvelopeSummary sendEnvelope(String base64, String signer_Email1, String signer_Name1)
...
//        doc2.setDocumentId("2");
		...
		/*
		 * CarbonCopy cc1 = new CarbonCopy(); cc1.setEmail(DSConfig.CC_EMAIL);
		 * cc1.setName(DSConfig.CC_NAME); cc1.setRoutingOrder("2");
