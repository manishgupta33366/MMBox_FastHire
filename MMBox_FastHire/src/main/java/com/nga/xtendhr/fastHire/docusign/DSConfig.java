...
public final class DSConfig {
    ...
    public static final String SIGNER_EMAIL1;
    public static final String SIGNER_NAME1;
    public static final String SIGNER_EMAIL2;
    public static final String SIGNER_NAME2;
    ...
    static {
        ...
        SIGNER_EMAIL1 = fetchValue(config, "DS_SIGNER_1_EMAIL");
        SIGNER_NAME1 = fetchValue(config, "DS_SIGNER_1_NAME");
        SIGNER_EMAIL2 = fetchValue(config, "DS_SIGNER_1_EMAIL");
        SIGNER_NAME2 = fetchValue(config, "DS_SIGNER_1_NAME");
    ...
    private static Map<String, String> loadFromProperties() {
        ...
        try {
            input = DSConfig.class.getResourceAsStream("/docusign_config.properties");
